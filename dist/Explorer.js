...
var AbstractView = function (_React$PureComponent5) {
  ...
  function AbstractView() {
    ...
    }, _this7._onClickDocsLink = function (type) {
      _this7.props.onClickDocsLink && _this7.props.onClickDocsLink(type);
        ...
        _react2.default.createElement(
          'span',
          {
            ...
            onClick: function onClick() {
              _this8._onClickDocsLink(implementingType);
            } },
          _react2.default.createElement(
            'svg',
            { width: '13px', height: '13px', viewBox: '0 1 20 13', version: '1.1' },
            _react2.default.createElement(
              'title',
              null,
              'Go to documentation'
            ...
            _react2.default.createElement(
              'g',
              { id: 'Icons', stroke: 'none' },
              _react2.default.createElement(
                'g',
                { id: 'Icon/search-no-circle', fill: '#000000' },
                _react2.default.createElement('path', { d: 'M11.2197212,11.8170545 C10.2786094,12.6498117 9.04855728,13.1573333 7.696,13.1573333 L7.696,13.1573333 C4.70933333,13.1573333 2.32,10.6826667 2.32,7.696 C2.32,4.70933333 4.70933333,2.32 7.696,2.32 C10.6826667,2.32 13.072,4.70933333 13.072,7.696 C13.072,9.02686119 12.5975737,10.2560596 11.8072747,11.2099413 L17.5946667,16.9973333 C17.7653333,17.168 17.7653333,17.424 17.5946667,17.5946667 C17.5093333,17.68 17.3386667,17.68 17.2533333,17.68 C17.168,17.68 17.0826667,17.68 16.9973333,17.5946667 L11.2197212,11.8170545 Z M7.696,3.088 C5.136,3.088 3.088,5.136 3.088,7.696 C3.088,10.256 5.136,12.304 7.696,12.304 C10.256,12.304 12.304,10.256 12.304,7.696 C12.304,5.136 10.256,3.088 7.696,3.088 Z', id: 'search-no-circle' })
              ),
              _react2.default.createElement('g', { id: 'Docs', transform: 'translate(-1829.000000, -388.000000)' })
            )
          )
        ),
        selection ? _react2.default.createElement(
          ...
          Object.keys(fields).sort().map(function (fieldName) {
            return _react2.default.createElement(FieldView, {
              ...
              onClickDocsLink: _this8.props.onClickDocsLink,
              schema: schema,
...
var FieldView = function (_React$PureComponent6) {
  ...
  function FieldView() {
    ...
    }, _this9._onClickDocsLink = function (field) {
      _this9.props.onClickDocsLink && _this9.props.onClickDocsLink(field);
    }, _temp5), _possibleConstructorReturn(_this9, _ret7);
  }

  _createClass(FieldView, [{
    key: '_renderInterfacesAndConcreteTypes',
    value: function _renderInterfacesAndConcreteTypes(parentType, childSelections) {
      var _this10 = this;

      var _props6 = this.props,
          schema = _props6.schema,
          getDefaultFieldNames = _props6.getDefaultFieldNames,
          getDefaultScalarArgValue = _props6.getDefaultScalarArgValue,
          makeDefaultArg = _props6.makeDefaultArg;


      var possibleConcreteTypes = schema.getPossibleTypes(parentType);

      var interfaces = (0, _util.uniq)((0, _util.flatMap)(possibleConcreteTypes, function (concreteType) {
        return concreteType.getInterfaces();
      }), function (interfaceType) {
        return interfaceType.name;
      });

      var interfacesAndConcreteTypes = possibleConcreteTypes.concat(interfaces).filter(function (type) {
        return type.name !== parentType.name;
      });

      return interfacesAndConcreteTypes.map(function (type) {
        return _react2.default.createElement(AbstractView, {
          ...
          onClickDocsLink: _this10._onClickDocsLink
        });
      });
    }
  }, {
      ...
      var node = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          {
            ...
            style: { cursor: 'pointer' },
            onClick: function onClick() {
              _this11._onClickDocsLink(field);
            } },
          _react2.default.createElement(
            'svg',
            { width: '13px', height: '13px', viewBox: '0 1 20 13', version: '1.1' },
          ...
          _react2.default.createElement(
            ...
            Object.keys(_fields4).sort().map(function (fieldName) {
              return _react2.default.createElement(FieldView, {
                ...
                schema: schema,
                onClickDocsLink: _this11._onClickDocsLink,
                getDefaultFieldNames: getDefaultFieldNames,
                getDefaultScalarArgValue: _this11.props.getDefaultScalarArgValue,
                makeDefaultArg: _this11.props.makeDefaultArg
              });
            }),
            (0, _graphql.isInterfaceType)(type) || (0, _graphql.isUnionType)(type) ? this._renderInterfacesAndConcreteTypes(type, childSelections) : null
          )
        );
      }
      return node;
...
var RootView = function (_React$PureComponent7) {
  ...
  function RootView() {
    ...
    return _ret8 = (_temp6 = (_this12 = _possibleConstructorReturn(this, (_ref7 = RootView.__proto__ || Object.getPrototypeOf(RootView)).call.apply(_ref7, [this].concat(args))), _this12), _this12._getOperationDef = function (parsedQuery) {
      var operation = parsedQuery.definitions.find(function (d) {
        return d.kind === 'OperationDefinition' && d.operation === _this12.props.operation;
      });
      var result = operation || {
        kind: 'OperationDefinition',
        operation: _this12.props.operation,
        selectionSet: {
          kind: 'SelectionSet',
          selections: []
        }
      ...
      return result;
    }, _this12._modifySelections = function (selections) {
      var parsedQuery = _this12.props.parsedQuery;

      var operationDef = _this12._getOperationDef(parsedQuery);
      ...
      if (selections.length === 0) {
        _this12._previousOperationDef = operationDef;
        _this12.props.onEdit((0, _graphql.print)(_extends({}, parsedQuery, {
    ...
    }, _temp6), _possibleConstructorReturn(_this12, _ret8);
  }
  ...
  _createClass(RootView, [{
    ...
    value: function render() {
      ...
      var _props8 = this.props,
          ...
          operation = _props8.operation,
          parsedQuery = _props8.parsedQuery,
          schema = _props8.schema,
          getDefaultFieldNames = _props8.getDefaultFieldNames,
          onClickDocsLink = _props8.onClickDocsLink;
...
var Explorer = function (_React$PureComponent8) {
  ...
  function Explorer() {
    ...
    return _ret9 = (_temp7 = (_this14 = _possibleConstructorReturn(this, (_ref8 = Explorer.__proto__ || Object.getPrototypeOf(Explorer)).call.apply(_ref8, [this].concat(args))), _this14), _this14._resetScroll = function () {
      var container = _this14._ref;
      if (container) {
        container.scrollLeft = 0;
      }
    }, _this14._onEdit = function (query) {
      _this14.props.onEdit(query);
    }, _temp7), _possibleConstructorReturn(_this14, _ret9);
  }
  ...
  _createClass(Explorer, [{
    ...
    value: function render() {
      ...
      var _props9 = this.props,
          ...
          query = _props9.query,
          makeDefaultArg = _props9.makeDefaultArg,
          onClickDocsLink = _props9.onClickDocsLink;
...
var ErrorBoundary = function (_React$Component) {
  ...
  function ErrorBoundary() {
    ...
    return _ret10 = (_temp8 = (_this16 = _possibleConstructorReturn(this, (_ref10 = ErrorBoundary.__proto__ || Object.getPrototypeOf(ErrorBoundary)).call.apply(_ref10, [this].concat(args))), _this16), _this16.state = { hasError: false, error: null, errorInfo: null }, _temp8), _possibleConstructorReturn(_this16, _ret10);
  }
